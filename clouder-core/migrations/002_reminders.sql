...
-- convert guild_configs.embed_color from integer to hex string (#RRGGBB) - idempotent
UPDATE guild_configs
SET
    embed_color = printf ('#%06X', embed_color)
WHERE
    embed_color IS NOT NULL
    AND typeof (embed_color) = 'integer';
